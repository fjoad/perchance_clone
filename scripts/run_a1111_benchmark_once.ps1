...
function Stop-BenchmarkProcesses {
    $targets = Get-CimInstance Win32_Process | Where-Object {
        ...
        ($_.Name -eq "python.exe" -and $_.CommandLine -match "stable-diffusion-webui|bench_a1111_hot_text_flow|launch.py") -or
...
try {
    ...
    $benchArgs = @(
        "scripts\bench_a1111_hot_text_flow.py",
