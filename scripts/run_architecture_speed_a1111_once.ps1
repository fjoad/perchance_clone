...
function Stop-BenchmarkProcesses {
    $targets = Get-CimInstance Win32_Process | Where-Object {
        ...
        ($_.Name -eq "python.exe" -and $_.CommandLine -match "stable-diffusion-webui|bench_architecture_speed_a1111|launch.py") -or
...
try {
    ...
    $benchArgs = @(
        "scripts\bench_architecture_speed_a1111.py",
